...
urlpatterns = [
    ...
    #List Users
    path('course/user/', ListCourseUser.as_view(), name="list_courseuser"),
    path('lesson/course/<int:pk>/', ListLessonCourseUser.as_view(), name="list_courseuser"),

    path('answer/user/', AnswersUserViewSet.as_view({'post': 'create'}), name='answers'),
